...
#' distance as a dissimilarity measure. Calculates 40Ar/39Ar ages,
#' isochrons, and age spectra. Computes weighted means accounting for
...
#' Sm-Nd, Lu-Hf, Rb-Sr and 230Th-U isochrons as well as 230Th-U
#' evolution plots.
#'
