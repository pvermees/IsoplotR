...
### Aliases: isochron isochron.default isochron.UPb isochron.PbPb
###   isochron.ArAr isochron.KCa isochron.RbSr isochron.ReOs isochron.SmNd
###   isochron.LuHf isochron.ThU isochron.UThHe
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("mclean", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("mds")
### * mds
